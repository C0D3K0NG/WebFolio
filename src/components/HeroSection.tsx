  ...
  return (
    <section className="relative h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full">
        ...
        >
          <rect className="dark:fill-venom-black fill-spidey-blue" width="1200" height="200" />
          <path 
            className="dark:fill-venom-red fill-spidey-red" 
      ...
      <div className="relative z-10 text-center px-6">
        ...
        <p className={cn(
          "text-lg md:text-xl mb-8 font-orbitron",
        ...
        {/* Spider thread */}
        <div className="relative h-16 w-[2px] mx-auto bg-foreground/30 mb-8">
          <div className={cn(
